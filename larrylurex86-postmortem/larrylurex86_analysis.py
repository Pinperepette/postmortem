#!/usr/bin/env python3
"""
Twitter account analysis for @Larrylurex86
Source: MongoDB SnareData.twitter
Stessa pipeline di alkampfer-postmortem: KPI organici + RT interest graph + diagnostics.
"""
...
TOPICS = {
    "Musica/Chitarra": ["chitarr", "guitar", "brian may", "queen ", "freddie mercury", "phil collins",
                        "ermal meta", "pausini", "rock ", "concerto", "concerti", "canzone", "canzoni",
                        "album", "musica", "music ", "fender", "gibson", "blues", "metal ", "solo di",
                        "riff", "band", "batter", "basso ", "live aid", "tour ", "spotify", "vinil"],
    "Cinema/TV":      ["kubrick", "american pie", "tom hardy", "film ", "attore", "attrice", "regist",
                       "hollywood", "netflix", "serie tv", "oscar", "cinema", "movie", "scena", "trailer",
                       "shannon elizabeth", "onlyfans", "spielberg", "tarantino", "scorsese", "documentari"],
    "Calcio/Sport":   ["calcio", "juve", "inter", "milan", "napoli", "roma", "lazio", "serie a",
                       "champions", "mondiali", "europei", "gattuso", "cagliari", "bosnia", "irlanda",
                       "palestra", "allenament", "workout", "fitness", "golf", "tiger woods", "masters",
                       "como ", "atalanta", "fiorentina", "torino", "genoa", "monza", "udinese", "lecce",
                       "tennis", "sinner", "alcaraz", "f1 ", "ferrari", "leclerc", "hamilton", "verstappen"],
    "Politica/Referendum": ["referendum", "politic", "governo", "meloni", "elezioni", "ministr",
                             "parlament", "salvini", "schlein", "putin", "trump", "destra", "sinistra",
                             "fasci", "comuni", "bossi", "lega ", "m5s", " pd ", " ue ", "europa",
                             "berlusconi", "renzi", "conte", "voto ", "scheda", "campagna elettorale"],
    "Spazio/Scienza": ["nasa", "artemis", "spazio", "astronaut", "satellit", "marte", "luna ", "iss",
                       "spacex", "starship", "esa ", "missione", "razzo", "telescopi", "galass",
                       "pianeta", "scienza", "scientif", "fisica", "einstein"],
    "Religione/Festività": ["pasqua", "buongiorno", "natale", "dio ", "papa ", "vaticano", "preghiera",
                              "festivit", "santo ", "santa ", "chiesa", "messa", "fede ", "cristian",
                              "buonasera", "buonanotte", "auguri"],
    "AI/Tech":        ["ai ", "intelligenza artificiale", "llm", "gpt", "claude", "gemini", "openai",
                       "anthropic", "chatgpt", "machine learning", "tecnologia", "tech ", "iphone",
                       "apple", "google", "microsoft", "meta ", "elon musk", "smartphone"],
    "Famiglia/Personale": ["figli", "moglie", "marito", "papà", "mamma", "scuola", "famiglia",
                             "casa ", "figlia", "figlio", "fidanzat", "father's day", "festa del papà",
                             "compleanno", "anniversari"],
    "Opinioni/Società": ["italia", "italiani", "società", "gente", "paese", "lavoro", "stipendi",
                           "tasse", "giovani", "ricchi", "poveri", "donne ", "uomini", "ragazz",
                           "boomer", "generazione", "razzism", "femminism"],
    "Media/Giornalismo": ["giornalist", "stampa", " tg ", " rai ", "mediaset", "repubblica", "corriere",
                            "fanpage", "ansa", "intervista", "telegiornale", "tg1", "tg5"],
    "Cybersecurity":  ["security", "hack", "vulnerabilit", "cyber", "phishing", "breach", "ransom",
                       "malware", "0day", "cve", "infosec"],
...
out_path = "/Users/pinperepette/Porgetti/tool-idea/larrylurex86-postmortem/larrylurex86_data.json"
