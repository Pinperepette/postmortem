#!/usr/bin/env python3
"""
Twitter account analysis for @michele_pinassi
Source: MongoDB SnareData.twitter
Includes: organic KPI stats + RT-based interest graph + growth diagnostics
grounded on the X For You algorithm (xai-org/x-algorithm).
"""
...
TOPICS = {
    ...
    "Politica":       ["politic", "governo", "meloni", "elezioni", "pd ", " ue ", "europa", "stato",
                       "ministr", "parlament", "salvini", "schlein", "putin", "trump"],
    ...
    "Opinioni/Società": ["italia", "italiani", "società", "gente", "paese"],
}
...
# flop: post with at least some text, no engagement
...
# ═══════════════════════════════════════════════════════════════════════════════
# 8. GROWTH DIAGNOSTICS — ancorati al wiki algoritmo
# ═══════════════════════════════════════════════════════════════════════════════
# Best posting hours (by avg_views, only hours with ≥3 posts)
...
out_path = "/Users/pinperepette/Porgetti/tool-idea/pinassi-postmortem/pinassi_data.json"
